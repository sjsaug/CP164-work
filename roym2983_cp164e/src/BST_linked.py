...
class BST:
    ...
    def are_flipped(self, target):
        ...
        -------------------------------------------------------
        """
        return self._are_flipped_aux(target._root)

    def _are_flipped_aux(self, node):
        """
        -------------------------------------------------------
        ...
        if node is None:
            ...
            return (node._left._value == node._right._value and
                    self._are_flipped_aux(node._left._left, node._right._right) and
                    self._are_flipped_aux(node._left._right, node._right._left))
        else:
            return equals
