...
class Deque:
    ...
    def is_mirror(self):
        ...
        while front_node is not rear_node and front_node._prev is not rear_node:
            if front_node._value != rear_node._value:
                mirror = False
                break
            front_node = front_node._next
            rear_node = rear_node._prev
