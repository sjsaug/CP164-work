...
class List:
    ...
    def split_count(self, count):
        ...
        if self._front is not None:
            ...
            if prev_node is not None:
                ...
                target1._rear = prev_node
            target2._front = node
            while node is not None:
                prev_node = node
                node = node._next
            target2._rear = prev_node
            self._front = None
            self._rear = None #idk if changing them back is necessary but jsut in case
    ...
    def rotate_rear(self):
        ...
        # Your code here
        if self._rear is not None and self._rear != self._front:
            node = self._front
    ...
    def has_loop(self):
        ...
        while fast is not None and fast._next is not None and fast != slow: #not 100% sure if fast._next needs to be checked here, but why not
            slow = slow._next
