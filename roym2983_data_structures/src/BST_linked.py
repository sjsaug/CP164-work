...
class BST:
    ...
    def __eq__aux(self, node1, node2):
        """
        ---------------------------------------------------------
        Determines whether two BSTs are equal.
        Values in self and target are compared and if all values are equal
        ...
        if node1 is None and node2 is None:
            ...
            equals = node1._value == node2._value and \
                self.__eq__aux(node1._left, node2._left) and \
                self.__eq__aux(node1._right, node2._right)
        else:
            equals = False
        return equals
    ...
    def leaf_count(self):
        ...
        # your code here
        n = self._root
        return self._leaf_count_aux(n)
    
    def _leaf_count_aux(self, node):
        """
        ---------------------------------------------------------
        Helper function to determine the number of leaves in a BST.
        Private operation called only by leaf_count.
        Use: count = self._leaf_count_aux(node)
        ---------------------------------------------------------
        Parameters:
            node - the root of the subtree to check (_BST_Node)
        Returns:
            count - number of leaves in the subtree (int)
        ---------------------------------------------------------
        """
        if node is None:
            count = 0
    ...
    def _two_child_count_aux(self, node):
        """
        ---------------------------------------------------------
        Helper function to determine the number of nodes with two children in a BST.
        Private operation called only by two_child_count.
        Use: count = self._two_child_count_aux(node)
        ---------------------------------------------------------
        Parameters:
            node - the root of the subtree to check (_BST_Node)
        Returns:
            count - number of nodes with two children in the subtree (int)
        ---------------------------------------------------------
        """
        if node is None:
            count = 0
    ...
    def one_child_count(self):
        ...
        # your code here
        node = self._root
        return self._one_child_count_aux(node)

    def _one_child_count_aux(self, node):
        """
        ---------------------------------------------------------
        Helper function to determine the number of nodes with one child in a BST.
        Private operation called only by one_child_count.
        Use: count = self._one_child_count_aux(node)
        ---------------------------------------------------------
        Parameters:
            node - the root of the subtree to check (_BST_Node)
        Returns:
            count - number of nodes with one child in the subtree (int)
        ---------------------------------------------------------
        """
        if node is None:
            count = 0
    ...
    def _is_balanced_aux(self, node):
        """
        ---------------------------------------------------------
        Helper function to determine if a BST is balanced.
        ...
        Parameters:
            node - the root of the subtree to check (_BST_Node)
        Returns:
            balanced - True if the subtree is balanced, False otherwise (boolean)
        ---------------------------------------------------------
        """
        ...
        if node is None:
            ...
            balanced = abs(self._node_height(node._left) - self._node_height(node._right)) <= 1 and \
                self._is_balanced_aux(node._left) and self._is_balanced_aux(node._right)
        return balanced
    ...
    def _is_valid_aux(self, node):
        """
        ---------------------------------------------------------
        Helper function to determine if a BST is valid.
        ...
        Parameters:
            node - the root of the subtree to check (_BST_Node)
        Returns:
            valid - True if the subtree is valid, False otherwise (boolean)
        ---------------------------------------------------------
        """
        ...
        if node is None:
            ...
            valid = self._is_valid_aux(node._left) and self._is_valid_aux(node._right) and \
                (node._left is None or node._left._value < node._value) and \
                (node._right is None or node._right._value > node._value) and \
    ...
    def _inorder_aux(self, node, a):
        """
        ---------------------------------------------------------
        Helper function to generate a list of the contents of the tree in inorder order.
        Private operation called only by inorder.
        Use: self._inorder_aux(node)
        ---------------------------------------------------------
        Parameters:
            node - the root of the subtree to generate the list (_BST_Node)
        Returns:
            None
        ---------------------------------------------------------
        """
    ...
    def _preorder_aux(self, node, a):
        """
        ---------------------------------------------------------
        Helper function to generate a list of the contents of the tree in preorder order.
        Private operation called only by preorder.
    ...
    def _postorder_aux(self, node, a):
        """
        ---------------------------------------------------------
        Helper function to generate a list of the contents of the tree in postorder order.
        Private operation called only by postorder.
